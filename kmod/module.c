...
int init_module() {
    ...
    //char arg_addr_6[] = {0x9e,0x35,0x28,0x76,0x25,0x44,0x67,0xfa,0xc9,0x25,0x00,0x00,0xfd,0x16,0x6d,0xb2}; // Little Endian Word Ordered
    char arg_addr_6[] = {0xfd,0x16,0x6d,0xb2,0xc9,0x25,0x00,0x00,0x25,0x44,0x67,0xfa,0x9e,0x35,0x28,0x76}; // Network Order
    
    in6_arg = kzalloc(sizeof(struct in6_addr),GFP_ATOMIC);
    memcpy(in6_arg,arg_addr_6,16);
    
    //char arg_addr_4[] = {1,254,168,192}; // Little Endian Byte Ordered
    char arg_addr_4[] = {192,168,254,001}; // Network Order
